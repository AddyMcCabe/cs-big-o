...
// ANSWER: no, because this for loop is stopped when it reaches 4 which keeps it from being an O(n) like most for loops
...
// ANSWER: both are the functions are dependent on the size of the string
